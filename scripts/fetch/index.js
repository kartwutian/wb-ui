...
const config = {
  cookie: 'sidebar_collapsed=false; UM_distinctid=16bab037033492-0334d3098d3e51-e343166-15f900-16bab037034964; CNZZDATA5879641=cnzz_eid%3D1596962110-1561939403-%26ntime%3D1561939403; _yapi_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjEzLCJpYXQiOjE1NzE2MTg5NDIsImV4cCI6MTU3MjIyMzc0Mn0.Jz2u6H0bg5taPd9ucthr4g5KI1nmOFMifYOdWqpQTC4; _yapi_uid=13',
  ...
  res.on('end', () => {
    ...
    const req1 = http.request(getOptions(config.apisPath), (res) => {
      ...
      res.on('end', () => {
        ...
        fs.writeFileSync('./scripts/fetch/api.json', JSON.stringify(generateApi(apisData.data.list, tagsData.data.tag), null, 2));
      });
    });
