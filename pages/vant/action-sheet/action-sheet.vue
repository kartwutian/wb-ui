...
export default {
  name: 'pages-action-sheet',
  components: { VanActionSheet, VanButton, DemoBlock },
  data () {
    return {
      show1: false,
      show2: false,
