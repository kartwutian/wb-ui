<template>
  <view
    :class="
      type === 'bottom' ? 'weui-tabbar weui-tabbar_bottom' : 'weui-tabbar'
    "
  >
    <view
    ...
    >
      <view v-if="tab.img" style="position: relative;display:inline-block;">
        <image
          :src="index === current ? tab.img.active : tab.img.normal"
          class="weui-tabbar__img"
        ></image>
      </view>
      <view
        v-if="tab.icon"
        :class="'weui-tabbar__icon wb-icon icon-' + tab.icon"
      ></view>
